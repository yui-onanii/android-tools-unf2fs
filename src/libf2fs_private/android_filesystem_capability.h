/*
 * taken from android-tools 34.0.4, later release killed this header
 * see core/libcutils/include/private/fs_config.h
 */
...
#endif  // _SYSTEM_CORE_INCLUDE_PRIVATE_ANDROID_FILESYSTEM_CAPABILITY_H
